...
namespace BusinessLayer.ValidationRules.ContactUs
{
    public class SendContactUsValidator: AbstractValidator<SendMessageDto>
    {
        public SendContactUsValidator()
        {
            ...
            RuleFor(x => x.Subject).MinimumLength(5).WithMessage("Konu alanına en az 5 karakter giriş yapınız");
            RuleFor(x => x.Subject).MaximumLength(100).WithMessage("Konu alanına en fazla 100 karakter giriş yapabilirsini");
