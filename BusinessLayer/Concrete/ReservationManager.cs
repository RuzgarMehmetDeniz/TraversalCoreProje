...
namespace BusinessLayer.Concrete
{
    public class ReservationManager : IReservationService
    {
        ...
        {
            return _reservationDal.GetListWithReservationAccepted(id);
        }
        ...
        public List<Reservation> GetListWithReservationPervious(int id)
        {
            return _reservationDal.GetListWithReservationPervious(id);
        }
